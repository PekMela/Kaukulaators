...
function rekinaa() {
    ...
    if (document.getElementById("gravy14").checked == true) {
        sum += parseFloat(document.getElementById("gravy14").value);
    }
    if (document.getElementById("gravy15").checked == true) {
        sum += parseFloat(document.getElementById("gravy15").value);
    }
    if (document.getElementById("gravy16").checked == true) {
        sum += parseFloat(document.getElementById("gravy16").value);
    }
    if (document.getElementById("gravy17").checked == true) {
        sum += parseFloat(document.getElementById("gravy17").value);
    }
    if (document.getElementById("gravy18").checked == true) {
        sum += parseFloat(document.getElementById("gravy18").value);
    }
    if (document.getElementById("gravy19").checked == true) {
        sum += parseFloat(document.getElementById("gravy19").value);
    }
    if (document.getElementById("gravy20").checked == true) {
        sum += parseFloat(document.getElementById("gravy20").value);
    }
    ...
    if (document.getElementById("gravvy11").checked == true) {
        sum += parseFloat(document.getElementById("gravvy11").value);
    }
    if (document.getElementById("gravvy12").checked == true) {
        sum += parseFloat(document.getElementById("gravvy12").value);
    }
    if (document.getElementById("gravvy13").checked == true) {
        sum += parseFloat(document.getElementById("gravvy13").value);
    }
    if (document.getElementById("gravvy14").checked == true) {
        sum += parseFloat(document.getElementById("gravvy14").value);
    }
    if (document.getElementById("gravvy15").checked == true) {
        sum += parseFloat(document.getElementById("gravvy15").value);
    }
    if (document.getElementById("gravvy16").checked == true) {
        sum += parseFloat(document.getElementById("gravvy16").value);
    }
    if (document.getElementById("gravvy17").checked == true) {
        sum += parseFloat(document.getElementById("gravvy17").value);
    }
    if (document.getElementById("gravvy18").checked == true) {
        sum += parseFloat(document.getElementById("gravvy18").value);
    }
    if (document.getElementById("gravvy19").checked == true) {
        sum += parseFloat(document.getElementById("gravvy19").value);
    }
    if (document.getElementById("gravvy20").checked == true) {
        sum += parseFloat(document.getElementById("gravvy20").value);
    }
    ...
    if (document.getElementById("graavvy7").checked == true) {
        sum += parseFloat(document.getElementById("graavvy7").value);
    }
    if (document.getElementById("graavvy8").checked == true) {
        sum += parseFloat(document.getElementById("graavvy8").value);
    }
    if (document.getElementById("graavvy9").checked == true) {
        sum += parseFloat(document.getElementById("graavvy9").value);
    }
    if (document.getElementById("graavvy10").checked == true) {
        sum += parseFloat(document.getElementById("graavvy10").value);
    }
    if (document.getElementById("graavvy11").checked == true) {
        sum += parseFloat(document.getElementById("graavvy11").value);
    }
    if (document.getElementById("graavvy12").checked == true) {
        sum += parseFloat(document.getElementById("graavvy12").value);
    }
    if (document.getElementById("graavvy13").checked == true) {
        sum += parseFloat(document.getElementById("graavvy13").value);
    }
    if (document.getElementById("graavvy14").checked == true) {
        sum += parseFloat(document.getElementById("graavvy14").value);
    }
    if (document.getElementById("graavvy15").checked == true) {
        sum += parseFloat(document.getElementById("graavvy15").value);
    }
    if (document.getElementById("graavvy16").checked == true) {
        sum += parseFloat(document.getElementById("graavvy16").value);
    }
    if (document.getElementById("graavvy17").checked == true) {
        sum += parseFloat(document.getElementById("graavvy17").value);
    }
    if (document.getElementById("graavvy18").checked == true) {
        sum += parseFloat(document.getElementById("graavvy18").value);
    }
